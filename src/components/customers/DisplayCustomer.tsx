...
export default function DisplayCustomer({ customers, handleDelete }: { customers: Customertype[]; handleDelete: (id: number) => Promise<void> }) {
                ...
                <div className='flex flex-col'>
                    {
                        customers.map(({ dealerid, name, number, totalcredit, totaldebit }, i) =>
                            <div key={i} className='grid border-t w-full grid-cols-9'>
                                <div className='px-2 py-1 border-r w-full'><h1 className='w-full text-center'>{i + 1}</h1></div>
                                ...
                                <div className='px-2 py-1 border-r w-full col-span-2 line-clamp-1'><h1 className='text-center'>{name}</h1></div>
                                <div className=' py-1 border-r w-full'><h1 className='text-center'>{number}</h1></div>
                                ...
                                <div className='col-span-2 py-1 justify-center flex w-full gap-2 px-2'>
                                    <button><InformationCircleIcon className='w-5' /></button>
                                    <button><PencilSquareIcon className='w-5' /></button>
